import DataProvider.LoginCasesDataProvider;
...
public class TestLogin {
    ...
    public void setup() {
        ...
        RestUtil.setBasePath("/login");
    }

    @Test(dataProvider = "loginCasesProvider", dataProviderClass = LoginCasesDataProvider.class)
    public void runLoginCases(String caseNo, String title, String code, String des, String runnable, String email, String password) {
